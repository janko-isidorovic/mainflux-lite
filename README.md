...
### Installation
Mainflux Lite uses [MongoDB](https://www.mongodb.com/) and [InfluxDB](https://influxdata.com/), so insure that these are installed on your system (more info on this can be found [here](https://github.com/Mainflux/mainflux-lite/blob/master/doc/dependencies.md))
